...
/*   Updated: 2021/04/28 05:19:10 by tayamamo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "checker.h"

static void	_run_ra(t_deque *a, t_deque *b)
{
	int	tmp;
...
static void	_run_rb(t_deque *a, t_deque *b)
{
	int	tmp;
...
static void	_run_rr(t_deque *a, t_deque *b)
{
	int	tmp;
