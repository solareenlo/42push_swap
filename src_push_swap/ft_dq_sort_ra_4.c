...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/26 07:22:24 by tayamamo          #+#    #+#             */
/*   Updated: 2021/04/26 07:34:21 by tayamamo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void	_dq_sort_ra_4_1(t_dq *dq, int type)
{
	if (type == 17)
...
static void	_dq_sort_ra_4_0(t_dq *dq, int type)
{
	if (type == 9)
