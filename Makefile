...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/04/21 19:12:41 by tayamamo          #+#    #+#              #
#    Updated: 2021/04/21 19:12:41 by tayamamo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

# Makefile for push_swap, updated Wed Apr 21 19:12:41 JST 2021
...
SRC_PS := ft_check_dup.c ft_check_int.c ft_cmp.c ft_dq_cmp_with_med.c ft_dq_copy.c ft_dq_dfs_a.c ft_dq_dfs_b.c ft_dq_free.c ft_dq_init.c ft_dq_sort.c ft_dq_sort_less_than_10.c ft_dq_sort_less_than_5.c ft_dq_sort_utils.c ft_exit.c ft_op_put.c ft_op_put_dq.c ft_op_run_dq.c main.c
OBJ_PS := ft_check_dup.o ft_check_int.o ft_cmp.o ft_dq_cmp_with_med.o ft_dq_copy.o ft_dq_dfs_a.o ft_dq_dfs_b.o ft_dq_free.o ft_dq_init.o ft_dq_sort.o ft_dq_sort_less_than_10.o ft_dq_sort_less_than_5.o ft_dq_sort_utils.o ft_exit.o ft_op_put.o ft_op_put_dq.o ft_op_run_dq.o main.o
