...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/04/23 17:19:34 by tayamamo          #+#    #+#              #
#    Updated: 2021/04/23 17:19:34 by tayamamo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

# Makefile for push_swap, updated Fri Apr 23 17:19:34 JST 2021
...
SRC_PS := ft_check_dup.c ft_check_int.c ft_cmp.c ft_deque_get_type4.c ft_dq_cmp_with_med.c ft_dq_copy.c ft_dq_dfs_a.c ft_dq_dfs_a_back.c ft_dq_dfs_b.c ft_dq_free.c ft_dq_init.c ft_dq_sort.c ft_dq_sort_less_than_10.c ft_dq_sort_less_than_5.c ft_dq_sort_pa_ra.c ft_dq_sort_ra.c ft_dq_sort_rra.c ft_dq_sort_utils.c ft_exit.c ft_op_put.c ft_op_put_dq.c ft_op_run_dq.c ft_op_run_dq_pa_ra.c ft_op_run_dq_ra.c main.c
