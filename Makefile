...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/04/28 05:08:07 by tayamamo          #+#    #+#              #
#    Updated: 2021/04/28 05:08:07 by tayamamo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

# Makefile for push_swap, updated Wed Apr 28 05:08:07 JST 2021

SRC_CH := ft_check_dup.c ft_check_int.c ft_check_ope.c ft_display_stack.c ft_exit.c ft_run_ope.c ft_run_ope_rr.c ft_run_ope_rrr.c main.c
OBJ_CH := ft_check_dup.o ft_check_int.o ft_check_ope.o ft_display_stack.o ft_exit.o ft_run_ope.o ft_run_ope_rr.o ft_run_ope_rrr.o main.o
